...
exp = Experiment("GeometryOptimization_ExpectedImprovement")
...
torch.save(train_y, "Results_train_y_ExpectedImprovement.pt")
torch.save(train_x, "Results_train_x_ExpectedImprovement.pt")
