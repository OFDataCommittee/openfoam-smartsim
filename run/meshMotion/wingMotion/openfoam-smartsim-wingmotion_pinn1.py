...
training_rs = exp.create_run_settings(exe="python", exe_args=f"mesh_trainer_pinn1.py {num_mpi_ranks}")
training_rs.set_tasks(1)
training_rs.set_nodes(1)
training_app = exp.create_model(name="training_app", run_settings=training_rs)
training_app.attach_generator_files(to_copy="mesh_trainer_pinn1.py")
